CREATE DATABASE  IF NOT EXISTS `goldenline` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `goldenline`;
...
CREATE TABLE `categories_articles` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Libelle_UNIQUE` (`libelle_categorie`),
...
INSERT INTO `categories_articles` VALUES (1,'Femme','F'),(2,'Homme','H'),(3,'Mixte','H/F'),(4,'Garçon','e_g'),(5,'Fille','e_f'),(6,'Mixte enfant','e_g/f');
